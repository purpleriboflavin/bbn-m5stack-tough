            ...
            if (value.is<String>())
            {
              ...
              if (val != NULL)
              {
                if (firstLoop)
                {
                  ...
                  RTCdate.Month = shipDataModel.environment.time_gps.t.tm_mon;
                  RTCdate.Date = shipDataModel.environment.time_gps.t.tm_mday;
                  M5.Rtc.SetDate(&RTCdate);

                  RTCtime.Hours = shipDataModel.environment.time_gps.t.tm_hour;
